      ...
      <div className="relative flex items-center justify-center overflow-hidden px-4 py-16 sm:py-24">
        ...
        <div className="relative w-full max-w-sm">
          <div className="text-center mb-8">
            ...
            <h1 className="mt-4 font-sans text-2xl font-bold text-white">Create your account</h1>
            <p className="text-sm text-white/75 mt-1">Sign up to start your CEFR level test</p>
          </div>

...
const NAV_ITEMS = [
  ...
  { href: "/admin/qr-codes", label: "Certificate QR", icon: QrIcon },
  { href: "/admin/enrollments", label: "Student QR Generation", icon: IdCardIcon },
  { href: "/admin/volunteer-teachers", label: "Volunteer Teacher QR", icon: ChalkboardIcon },
